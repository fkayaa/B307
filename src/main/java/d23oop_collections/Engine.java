...
*/
        ...
        //yazmasan da olur olanlar soluktur
        int price1 = 2500;

        int fiyat = 300; //default olarak public static final

        //default method :
        //bu methodlar body li oldugundan kullanılması zorunlu değil
        //burdaki default keyword tür
        default void power(){
        ...
        //static method
        static void speed() {
                System.out.println("Saatte 300 km");
        }
...
//Engine interface'inden gelen run() calisti