...
public class Lambda01 {
    ...
    public static void printElements2(List<Integer> nums) {
        ...
        // t ->, akistan gelen her bir t (data) icin
    ...
    //Example 4: Find all even numbers in a List<Integer> and write a method that prints
    // these numbers to the console on the same line, with a space between them.(functional)
