...
//            myItr.remove(); //next()'in verdigi elemani siler
        ...
        ListIterator<String> listItr2 = yourList2.listIterator(yourList2.size()); //yourList2.size() pointer'i sona goturur

        //bu loop pointer'i en saga almak icin yazildi

//        while (listItr2.hasNext()) { //yourList2.size() ayni isi yapar
//            listItr2.next();
//        }
