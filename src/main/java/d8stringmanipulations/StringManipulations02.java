...
*/
        ...
        // method chan - method zinciri  metotları arka arkaya kullanmaktır.
        // data tipinde en son kullanılan method neyse o secılır.

        int s2 = s.replaceAll("[^0-9]","").length();
        System.out.println( s2 + " tane rakam vardır. " );
