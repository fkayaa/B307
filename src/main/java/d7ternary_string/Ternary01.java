...
public class Ternary01 {
    public static void main(String[] args) {
        ...
        int result = c>0 ? c : -1 * c;//0 dan büyükse true da aynen kendisine eşittir.değilse -1 ile çarpmak gerekir.
        ...
        int b = -4;
         ...
         Object result1 = (a>0 && b>0) || (a<0 && b<0) ? a * b : "Farklı işaretli sayıları çarpamıyorum";//object string ve int i kapsar--> ortak parenttır object
