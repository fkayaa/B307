 ...
 */
    ...
    //Arastırma ödevi
    //encapsulation'da set ile verileri degistirebiliyoruz. constructorlar ile de degistirebiliyoruz. Farki nedir?
    ...
    //Kullanıcı Rolüne Dayalı Erişim Kontrolü (Role-Based Access Control - RBAC)
    //Aspect-Oriented Programming (AOP) Kullanarak Erişim Kontrolü
