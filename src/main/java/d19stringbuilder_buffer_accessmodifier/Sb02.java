...
public class Sb02 {
    public static void main(String[] args) {
        ...
        sb1.reverse();
        System.out.println(sb1); //ysae si avaJ ==> Ters çevirdi
        ...
        System.out.println(result);//15 ==> Ascii tablosunda Z nin degeri 90 , K nın 75 ,farkları ==> 15 geldi,ikisi aynı olsaydı eger 0 çıkardı...

        //-----------------------------------------
        //7-toString() metodu, StringBuilder nesnesinin içeriğini bir String nesnesine dönüştürür.
        //String classlar çok zengin oldugu için , dönüştürme yapılır
        ...
        System.out.println(newSb1); //HA34SANSİ AVAJ dönüştü...
