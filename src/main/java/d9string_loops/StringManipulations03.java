...
public class StringManipulations03 {
    public static void main(String[] args) {
        ...
        String pwd = " a ";
        boolean first = pwd.isEmpty(); //boş mu sorusudur.hiçlik varsa true dur,space de hiçlik yoktur,false verir
        ...
        boolean second = pwd.isBlank(); //hem hiçlikte hem space de true verir
        ...
        System.out.println("başında ve sonunda boşluk varsa false/yoksa true =  " + third);
