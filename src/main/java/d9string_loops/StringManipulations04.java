...
*/
       ...
       */
        ...
        System.out.println(str1 == str2);//adresleri farklı/false çıkar
        System.out.println(str1.equals(str2));//true çünkü adrese bakmadan sadece içeriğe bakar
        System.out.println(str1 == str3);//true çünkü adresleri aynı

        //adresler stack te, classlar heapte
