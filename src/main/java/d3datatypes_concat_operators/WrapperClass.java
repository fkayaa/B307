...
method kullaniminin da yolunu acar.*/
        ...
        int i = 12; //i. dediğimizde methodlar görünmez-açılmaz

        Integer k = 12; //k. yazıldıgında methodlar açılır,çünkü Integer bir classtır
        ...
        Unboxing ise tam tersi bir işlem yapar,
        ...
        int num = 13;
        Integer wrapperNum = num; //wrapperNum için artık method açılır
       //-------------------------------------------------
        //Ornek 2 : Wrapper Byte'i primitive byte'a ceviriniz.--unboxing
        //Example 2: Convert Wrapper Byte to primitive byte

        Byte s = 19;
        byte primitiveS = s; //primitiveS için artık methodlar açılmaz
