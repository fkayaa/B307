...
public class Scanner01 {
    public static void main(String[] args) {
        ...
        *Bu kütüphaneler, Java geliştiricilerinin daha hızlı ve etkili bir şekilde programlama
        yapabilmelerine olanak tanır.
        * Java kütüphaneleri genellikle .jar (Java Archive) dosyaları olarak dağıtılır.
        Java'nın standart kütüphanesi (Java Standard Library),
        *  Java Development Kit (JDK) ile birlikte gelir
        ve dilin temel yapısını oluşturur.
        * Java'da bir kütüphaneyi kullanabilmek için import anahtar kelimesi
