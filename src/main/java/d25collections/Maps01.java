...
public class Maps01 {
    public static void main(String[] args) {
        ...
        myMap.put("Zehra Kaya",12);
        myMap.put("Fatma Kaya",37);

        System.out.println(myMap);//{Ali Can=13, Veli Han=18, Zehra Kaya=12, Fatma Kaya=37}

        myMap.put("Ali Can",25);//{Ali Can=25, Veli Han=18, Zehra Kaya=12, Fatma Kaya=37}
        System.out.println(myMap); //key tekrarli kullanilirsa son value aktif olur

        //Sadece 'key' degerlerini nasıl alırız
        //keySet(): Map’teki tüm key’lerin bir set’ini döndürür.Set’in sırası rastgeledir.

       Set<String> keySide =  myMap.keySet(); //bir map e .keySet(); yaptıgımızda sadece key lerini alabiliriz
        System.out.println(keySide);//[Ali Can, Veli Han, Zehra Kaya, Fatma Kaya]
        ...
        System.out.println(valueSide);//[25, 18, 12, 37]
    ...
    Integer age = myMap.get("Ali Can");
        ...
        Integer ort = total/ages.size();

        System.out.println(ort);//23
        ...
        System.out.println(myMap);//{Ali Can=25, Veli Han=18, Zehra Kaya=12, Fatma Kaya=37}

              Set<Map.Entry<String,Integer>> myEntrySet = myMap.entrySet(); //data type  "Map.Entry<String,Integer>"

              System.out.println(myEntrySet);//[Ali Can=25, Veli Han=18, Zehra Kaya=12, Fatma Kaya=37] ==> süslü parantez köşeli parantez oldu---4 elemanlı bir veri oldu

        for (Map.Entry<String,Integer> w : myEntrySet) { //var da çalısır burda
