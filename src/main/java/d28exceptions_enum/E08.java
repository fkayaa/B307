...
*/
        ...
        while ((k = fis.read()) != -1) { //dosya sonuna ulaşıldığında -1 değerini döndürur.

            System.out.print((char)k);//Java kolaydir
            // k isimli int türünde ki değişkeni değerini char türüne dönüstürdük bu işleme "tip dönüşümü " ya da "type casting" denir
