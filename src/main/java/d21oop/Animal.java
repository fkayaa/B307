...
public class Animal { //final bir class'in child'i olmaz.
    ...
    */
    ...
    //--------------------------------
    //Override isleminde access modifier’larin
    // durumlari ne olmalidir, onu ogrenelim
    ...
    //Parent icinde data type’i olan bir method olusturup
    // child’da override edelim

    //-----------------
    //Parent’ta int veri turunde bir method acip,
    // child’da override etseydik ne olurdu?

    //-----------------
    //Peki Parent’ta Class veri turunde bir
    // method acip, child’da override etseydik ne olurdu?
    ...
    public void eat() { //final bir metot override edilemez
        System.out.println("Animals eat...");
        final double pi = 3.14;
        //pi = 3; baska deger kabul etmez
    }
