 ...
 */
        ...
        division3(3,1);//ArithmeticException
    ...
    public static void division2(int a,int b) {
        ...
        try {
            ...
            System.out.println(a / b);//hata fırlattıgı an bu blokta çalısma durdu , catch çalıstırıldı

            System.out.println("try içi görev tamamlandı");

        }catch (ArithmeticException e){

            System.out.println("Lütfen 0'a bölme işlemi yapmayın ... ");
            //System.out.println(0); kabulunu yapabilirdik
        }
