...
public class CourseRunner {
    public static void main(String[] args) {
        ...
        Course courseTurkishDay = new Course("Summer" , "TurkishDay" ,97 ,128);
     ...
     //   System.out.println(coursesList);
        /*
        [Course{season='Summer', courseName='TurkishDay', averageScore=97, numberOfStudents=128},
       ...
       //Eğer akıştaki hiçbir eleman koşulu karşılamıyorsa true döndürür, aksi takdirde false döndürür.
        ...
        System.out.println(result5);//true ---> içermiyor anlamında true
        ...
        System.out.println(result6);//true ---> içermiyor anlamında true
     ...
     /*   String result7 = coursesList.stream().sorted(Comparator.comparing(Course::getAverageScore).reversed()).findFirst().get().getCourseName();
        System.out.println(result7);//Turkish Night*/

        String result7 = coursesList.stream().max(Comparator.comparing(Course::getAverageScore)).get().getCourseName(); //max kullandık
        ...
        // and write it to the console as a list, excluding the first two.//8) Tum course object'lerini average score'a gore kucukten buyuge diziniz
        // ve ilk ikisi haric liste halinde console'a yazdiriniz.
        //8) Arrange all course objects from smallest to largest according to average score
       ...
       //b) collect(Collectors.toList()), Stream içerisindeki elemanları bir listeye dönüştürür.
        ...
        List<Course> myList = coursesList.stream().sorted(Comparator.comparing(Course::getAverageScore)).skip(2).collect(Collectors.toList());
        System.out.println(myList);//97/98
/*
[Course{season='Summer', courseName='TurkishDay', averageScore=97, numberOfStudents=128},
Course{season='Winter', courseName='Turkish Night', averageScore=98, numberOfStudents=154}]
 */
        ...
        System.out.println("-----------------------------------------------------------------");
        List<Course> coursesListSorted = coursesList.stream().sorted(Comparator.comparing(Course::getNumberOfStudents).reversed()).collect(Collectors.toList());
       ...
       // 11) Write the code that gives the number of English sections in the course.
        ...
        List<Course> newCourses = coursesList.
                stream().
                filter(t -> t.getNumberOfStudents() < 140).toList();
