...
public class LinkedList01 {
   ...
   //----------------------------------
        ...
        List<String> list2 = new ArrayList<>(); //bu ifade tür esnekliği sağlıyor.

        //List<String> list3 = new List<String>();  ===> Constructor tarafına interface yazılamaz.
...
//1-add() : listeye bir eleman ekler
      ...
      // Bu, standart ve en yaygın yöntemdir. Ancak, LinkedList'e eleman eklemek için daha "kısa yollar" bulunmaktadır.
       ...
       // System.out.println(linkedList);//[Eleman1, Eleman2, Eleman3]
        ...
        //dogrudan yazdırmak için constructor içinde ; Arrays.asList() içine yazılır
...
//--------------------------------------------------------------------------------------------------------------------------------------------------
       ...
       // immutableList.add("Fatma");//hata fırlattı ===> eleman ekleyemeyiz,list.of tan sonra
       ...
       // System.out.println(mutableList);//[Eleman1, Yeni Eleman, Eleman3]
        ...
        System.out.println(m1); //true ===> buldu ve sildi
      ...
      /*  System.out.println(myList);//[Hasan, Zeynep, Veli, Yusuf, Ayse, Fatma, Huseyin, Yusuf]
        myList.removeFirstOccurrence("Yusuf");//ilk yusuf gider
        System.out.println(myList); //[Hasan, Zeynep, Veli, Ayse, Fatma, Huseyin, Yusuf]

        myList.removeFirstOccurrence("Yusuf");//sonraki yusufu siler,çünkü sadece o kaldı
        System.out.println(myList);//[Hasan, Zeynep, Veli, Ayse, Fatma, Huseyin]

*/

       // myList.removeAll(Collections.singleton("Yusuf"));//Listeyi komple tarar ve bütün Yusufları siler
       // System.out.println(myList);//[Hasan, Zeynep, Veli, Ayse, Fatma, Huseyin]
...
//----------------------------------------------------------------------------------------------------
        ...
        myList.poll(); //Hasan
        System.out.println(myList);//[Zeynep, Veli, Yusuf, Ayse, Fatma, Huseyin] ===>ilkini çekti
        ...
        System.out.println(myList);//[Zeynep, Veli, Yusuf, Ayse, Fatma, Huseyin] ---> peek() ile çok yakın
       ...
       // Bu metod, koleksiyon boşsa NoSuchElementException istisnası atar.(poll() null dondurur)
        ...
        System.out.println(myList);//[Veli, Yusuf, Ayse, Fatma, Huseyin] -----> poll() ile aynıdır
